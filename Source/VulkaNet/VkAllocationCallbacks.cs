...
namespace VulkaNet
{
    ...
    {
        public static int SafeMarshalSize(this VkAllocationCallbacks s)
            => s != null
                ? VkAllocationCallbacks.Raw.SizeInBytes
                : 0;

        public static unsafe VkAllocationCallbacks.Raw* SafeMarshalTo(this VkAllocationCallbacks s, ref byte* unmanaged)
        {
            if (s == null)
